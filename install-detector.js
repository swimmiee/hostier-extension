(function () {
  if (globalThis.__HOSTIER_INSTALL_DETECTOR_ACTIVE__) return;
  globalThis.__HOSTIER_INSTALL_DETECTOR_ACTIVE__ = true;
  ...
  function markExtensionInstalled() {
    ...
    root.dispatchEvent(new CustomEvent(HOSTIER_EXTENSION_INSTALLED_EVENT, { detail: { version } }));
  }

  document.documentElement?.addEventListener(HOSTIER_EXTENSION_PING_EVENT, markExtensionInstalled);
